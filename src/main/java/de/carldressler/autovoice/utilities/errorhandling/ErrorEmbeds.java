...
public class ErrorEmbeds {
    ...
    static MessageEmbed getInvalidSyntax(CommandContext ctxt) {
        EmbedBuilder embedBuilder = new EmbedBuilder()
                .setColor(Constants.ERROR_COLOR)
                .setTitle(EmoteUtils.ERROR + "  Invalid syntax");
        if (ctxt.command.getExampleUsage() != null) {
            return embedBuilder
                    .setDescription("The structure of the command is invalid. Please fix the structure and call the command again.\n" +
                            ...
                            "\n" +
                            "For more information, please refer to `" + Constants.PREFIX + "help " + ctxt.command.getName() + "`.") // TODO add name
                    .build();
        } else {
            return embedBuilder
                    .setDescription("The structure of the command is invalid. Please fix the structure and call the command again.\n" +
    ...
    static MessageEmbed getDevOnly() {
        return new EmbedBuilder()
                .setColor(Constants.ERROR_COLOR)
                .setTitle(EmoteUtils.ERROR + "  Developer-only command")
    ...
    static MessageEmbed getDisabled() {
        return new EmbedBuilder()
                .setColor(Constants.ERROR_COLOR)
                .setTitle(EmoteUtils.ERROR + "  Command is disabled")
    ...
    static MessageEmbed getGuildOnly() {
        return new EmbedBuilder()
                .setColor(Constants.ERROR_COLOR)
                .setTitle(EmoteUtils.ERROR + "  Command is guild only")
    ...
    static MessageEmbed getDMOnly() {
        return new EmbedBuilder()
                .setColor(Constants.ERROR_COLOR)
                .setTitle(EmoteUtils.ERROR + "  Command is DM only")
    ...
    static MessageEmbed getNoAutoChannel() {
        return new EmbedBuilder()
                .setColor(Constants.ERROR_COLOR)
                .setTitle(EmoteUtils.ERROR + "  No auto channel detected")
    ...
    static MessageEmbed getChannelAdminRequired() {
        return new EmbedBuilder()
                .setColor(Constants.ERROR_COLOR)
                .setTitle(EmoteUtils.ERROR + "  Channel admin required")
    ...
    static MessageEmbed getClosedDMs() {
        return new EmbedBuilder()
                .setColor(Constants.ERROR_COLOR)
                .setTitle(EmoteUtils.ERROR + "  Direct messages are disabled")
    ...
    private static MessageEmbed getInvalidMention() {
        return new EmbedBuilder()
            .setColor(Constants.ERROR_COLOR)
            .setTitle(EmoteUtils.ERROR + "  Invalid mention")
    ...
    private static MessageEmbed getNotInTempChannel() {
        return new EmbedBuilder()
                .setColor(Constants.ERROR_COLOR)
                .setTitle(EmoteUtils.ERROR + "  Not in voice channel")
    ...
    public static MessageEmbed getOnCooldown() {
        return new EmbedBuilder()
                .setColor(Constants.ERROR_COLOR)
                .setTitle(EmoteUtils.TIME + "  You're on cooldown")
    ...
    static MessageEmbed getNotImplemented() {
        return new EmbedBuilder()
                .setColor(Constants.ERROR_COLOR)
                .setTitle(EmoteUtils.ERROR + "  Easter egg!")
    ...
    static MessageEmbed getUnknown() {
        return new EmbedBuilder()
                .setColor(Constants.ERROR_COLOR)
                .setTitle(EmoteUtils.ERROR + "  Unknown error")
